...
import { BinaryBlob, JsonValue } from './types';
/**
...
declare class TypeTable {
    ...
    add<T>(type: ConstructType<T>, buf: Buffer): void;
    merge<T>(obj: ConstructType<T>, knot: string): void;
    encode(): Buffer;
    indexOf(typeName: string): Buffer;
}
...
export declare abstract class Type<T = any> {
     ...
     * @internal
     */
    abstract encodeValue(x: T): Buffer;
    /**
     * Implement `I` in the IDL spec.
     * Encode this type for the type table.
     */
    abstract encodeType(typeTable: TypeTable): Buffer;
...
export declare class IntClass extends PrimitiveType<bigint> {
    ...
    encodeValue(x: bigint | number): Buffer;
    encodeType(): Buffer;
 ...
 */
export declare function encode(argTypes: Array<Type<any>>, args: any[]): BinaryBlob;
/**
 ...
 */
export declare function decode(retTypes: Type[], bytes: Buffer): JsonValue[];
/**
